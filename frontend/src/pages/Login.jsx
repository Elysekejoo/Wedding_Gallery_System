      ...
      <div className="lg:w-1/2 bg-gray-900 relative overflow-hidden hidden lg:flex flex-col justify-between p-12">
        ...
        <div className="relative z-10">
          ...
          <div className="max-w-md">
            ...
            <p className="text-gray-300 text-lg">Sign in to manage your galleries, upload photos, and share memories with your clients.</p>
          </div>
        </div>
        ...
        <div className="max-w-md w-full">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-xl p-6 sm:p-8">
            <div className="text-center mb-6">
              <h2 className="text-2xl font-bold text-gray-900">Photographer Login</h2>
